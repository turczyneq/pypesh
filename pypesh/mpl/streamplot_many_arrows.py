...
Streamline plotting for 2D vector fields with option of multiple arrows 
...
__all__ = ['streamplot_many_arrows']


def streamplot_many_arrows(axes, x, y, u, v, density=1, linewidth=None, color=None,
...
# streamplot_many_arrows(plt.gca(), X, Y, U, V, density=[0.5, 1], num_arrows=10)
# plt.show()