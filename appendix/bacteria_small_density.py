...
print(3600*24*stokes(0.001, rho_list[0]))
...
line_4 = np.array(for_line(10 ** (-3), drho=0.01))
...
added_text = CurvedText(
    ...
    y=line_3[18:],
    text=r"varying range for: 30 kg/$\textrm{m}^3$ $<$ $\Delta \rho$ $<$ 200 kg/$\textrm{m}^3$",
    ha="center",
    va="center",
    axes=plt.gca(),
    fontsize=fontsize,
...
tosave = parent_dir / "graphics/encounter_type_small_density.pdf"
plt.savefig(
    tosave,
    bbox_inches="tight",
    pad_inches=0.02,
