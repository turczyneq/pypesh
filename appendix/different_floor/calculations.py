...
peclet = args.peclet
start = time.time()
sol = fem._sherwood_fem_custom_mesh(peclet, ball_radius, floor=5), fem._sherwood_fem_custom_mesh(peclet, ball_radius, floor=10), fem._sherwood_fem_custom_mesh(peclet, ball_radius, floor=20)
end = time.time()
